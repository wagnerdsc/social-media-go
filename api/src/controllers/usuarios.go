...
func CriarUsuario(w http.ResponseWriter, r *http.Request) {
	corpoRequest, erro := ioutil.ReadAll(r.Body) // .Write([]byte("Criando usuário!"))
	if erro != nil {
...
// BuscarUsuario busca um usuário especifico do banco
...
// AtualizarUsuario altera um usuário do banco
